...
//=========  (Wed Jul 21 05:29:03 2021) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(24561,4.534287,24651,18.60183);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(5.941041);
   Graph_Graph1003->SetMaximum(17.19508);
