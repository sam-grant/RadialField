void BrVsRun_Run5b_Nearline_46130_46133()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Nov 10 14:33:25 2021) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(46129.25,-2.5,46133.75,22.5);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,46129.7,46133.3);
   ...
   Double_t Graph1_fx1004[4] = {
   46130,
   46131,
   46132,
   46133};
   Double_t Graph1_fy1004[4] = {
   -15.33282,
   -15.183,
   -15.26383,
   -15.5056};
   Double_t Graph1_fex1004[4] = {
   0,
   0,
   0,
   0};
   Double_t Graph1_fey1004[4] = {
   0.3491853,
   0.1778331,
   0.171357,
   1.038102};
   gre = new TGraphErrors(4,Graph1_fx1004,Graph1_fy1004,Graph1_fex1004,Graph1_fey1004);
   gre->SetName("Graph1");
   gre->SetTitle("Graph");
   ...
   TH1F *Graph_Graph1004 = new TH1F("Graph_Graph1004","Graph",100,46129.7,46133.3);
   Graph_Graph1004->SetMinimum(-16.75132);
   Graph_Graph1004->SetMaximum(-14.25988);
