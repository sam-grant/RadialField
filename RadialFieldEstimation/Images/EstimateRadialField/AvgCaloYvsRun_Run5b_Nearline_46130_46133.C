void AvgCaloYvsRun_Run5b_Nearline_46130_46133()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Nov 10 14:33:23 2021) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(46129.25,73.62785,46133.75,73.78403);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,46129.7,46133.3);
   Graph_Graph1001->SetMinimum(73.64347);
   Graph_Graph1001->SetMaximum(73.76841);
