...
//=========  (Sun Jan 30 09:45:17 2022) by ROOT version 6.12/04
   ...
   hist__2->SetBinContent(1010,3);
   hist__2->SetBinContent(1011,23);
   hist__2->SetBinContent(1012,19);
   hist__2->SetBinContent(1013,12);
   hist__2->SetBinContent(1014,4);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.103
#pm0.009
");
   pt->Draw();
