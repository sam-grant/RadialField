...
//=========  (Sun Jan 30 09:46:03 2022) by ROOT version 6.12/04
   ...
   hist__2->SetBinContent(1015,17);
   hist__2->SetBinContent(1016,54);
   hist__2->SetBinContent(1017,56);
   hist__2->SetBinContent(1018,66);
   hist__2->SetBinContent(1019,21);
   hist__2->SetBinContent(1020,38);
   hist__2->SetBinContent(1021,11);
   hist__2->SetBinContent(1022,2);
