void h_yRunAvg_gm2pro_daq_offline_dqc_run3N_5207A_34184_34618()
{
...
//=========  (Wed May 26 18:38:22 2021) by ROOT version 6.12/04
   ...
   h_yRunAvg__2->SetBinContent(7487,1);
   h_yRunAvg__2->SetBinContent(7497,2);
   h_yRunAvg__2->SetBinContent(7498,2);
   h_yRunAvg__2->SetBinContent(7499,8);
   h_yRunAvg__2->SetBinContent(7500,16);
   h_yRunAvg__2->SetBinContent(7501,26);
   h_yRunAvg__2->SetBinContent(7502,22);
   h_yRunAvg__2->SetBinContent(7503,26);
   h_yRunAvg__2->SetBinContent(7504,37);
   h_yRunAvg__2->SetBinContent(7505,35);
   h_yRunAvg__2->SetBinContent(7506,21);
   h_yRunAvg__2->SetBinContent(7507,10);
   h_yRunAvg__2->SetBinContent(7508,2);
   h_yRunAvg__2->SetBinContent(7509,1);
   h_yRunAvg__2->SetBinContent(7510,1);
   h_yRunAvg__2->SetBinContent(7520,1);
   h_yRunAvg__2->SetBinContent(7524,1);
   h_yRunAvg__2->SetEntries(212);
