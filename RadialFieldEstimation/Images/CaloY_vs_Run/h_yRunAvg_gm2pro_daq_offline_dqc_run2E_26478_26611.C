void h_yRunAvg_gm2pro_daq_offline_dqc_run2E_26478_26611()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May 26 18:37:36 2021) by ROOT version 6.12/04
   ...
   h_yRunAvg__2->SetBinContent(7509,2);
   h_yRunAvg__2->SetBinContent(7510,11);
   h_yRunAvg__2->SetBinContent(7511,11);
   h_yRunAvg__2->SetBinContent(7512,7);
   h_yRunAvg__2->SetBinContent(7513,4);
   h_yRunAvg__2->SetBinContent(7514,5);
   h_yRunAvg__2->SetBinContent(7515,5);
   h_yRunAvg__2->SetBinContent(7516,7);
   h_yRunAvg__2->SetBinContent(7517,3);
   h_yRunAvg__2->SetBinContent(7518,1);
   h_yRunAvg__2->SetBinContent(7519,1);
   h_yRunAvg__2->SetBinContent(7534,1);
