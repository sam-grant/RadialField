...
//=========  (Fri Jul  2 05:19:33 2021) by ROOT version 6.12/04
   ...
   hist__1->SetBinContent(19,2);
   hist__1->SetEntries(23);
   hist__1->SetStats(0);
   hist__1->SetFillColor(1);
   hist__1->SetFillStyle(3001);
   hist__1->GetXaxis()->SetTitle("(#LTy_{n}#GT #minus #LTy_{n+1}#GT)_{Run-4} #minus (#LTy_{n}#GT #minus #LTy_{n+1}#GT)_{Run-1d} [mm]");
