...
//=========  (Fri Jul  2 05:21:32 2021) by ROOT version 6.12/04
   ...
   hist__1->GetXaxis()->SetTitle("(#LTy_{n}#GT #minus #LTy_{n+1}#GT)_{Run-4} #minus (#LTy_{n}#GT #minus #LTy_{n+1}#GT)_{Run-2f} [mm]");
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(20);
   TText *pt_LaTex = pt->AddText("-0.009
#pm0.04
");
