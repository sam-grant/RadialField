...
//=========  (Fri May 28 13:38:33 2021) by ROOT version 6.12/04
   ...
   hist__1->SetBinContent(11,22);
   hist__1->SetEntries(22);
   hist__1->SetStats(0);
   hist__1->SetFillColor(1);
   hist__1->SetFillStyle(3001);
   hist__1->GetXaxis()->SetTitle("(#LTy_{n}#GT #minus #LTy_{1}#GT)_{Run-4} #minus (#LTy_{n}#GT #minus #LTy_{1}#GT)_{Run-4} [mm]");
