...
//=========  (Tue May 25 07:37:08 2021) by ROOT version 6.12/04
   ...
   gre->SetName("Graph0");
   gre->SetTitle(";Run1;B_{r} [ppm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1004 = new TH1F("Graph_Graph1004","",100,1.4,2.6);
   Graph_Graph1004->SetMinimum(15.52487);
   Graph_Graph1004->SetMaximum(31.78224);
   ...
   Graph_Graph1004->GetXaxis()->SetTitle("Run1");
